...
std::string io::read_file(const char* filePath) {
	std::string contents;
	FILE* file;
...
std::vector<std::string> io::read_file_lines(const char* filePath) {
...
bool io::file_exists(const char* filePath) {
	FILE* file;
...
uintmax_t io::get_file_size(const char* filePath) {
	uintmax_t bytes;
	FILE* file;
